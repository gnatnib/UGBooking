                        ...
                        <div class="row formtype">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label>Name</label>
                                    <input class="form-control" type="text" name="name" value="{{ $roomEdit->name }}"
                                        readonly>
                                </div>
                            </div>
                            <div class="col-md-4">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select class="form-control @error('ac_non_ac') is-invalid @enderror" id="ac_non_ac"
                                        name="ac_non_ac">
                                        <option selected value="{{ $roomEdit->ac_non_ac }}">{{ $roomEdit->ac_non_ac }}
                                        </option>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select class="form-control @error('bed_count') is-invalid @enderror" id="bed_count"
                                        name="bed_count">
                                        <option selected value="{{ $roomEdit->bed_count }}">{{ $roomEdit->bed_count }}
                                        </option>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select class="form-control @error('charges_for_cancellation') is-invalid @enderror"
                                        ...
                                        <option selected value="{{ $roomEdit->charges_for_cancellation }}">
                                            {{ $roomEdit->charges_for_cancellation }}</option>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('rent') is-invalid @enderror"
                                        id="rent" name="rent" value="{{ $roomEdit->rent }}">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control @error('phone_number') is-invalid @enderror"
                                        id="phone_number" name="phone_number" value="{{ $roomEdit->phone_number }}">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <div class="custom-file mb-3">
                                        ...
                                        <input type="hidden" class="form-control" name="hidden_fileupload"
                                            value="{{ $roomEdit->fileupload }}">
                                        <a href="profile.html" class="avatar avatar-sm mr-2">
                                            <img class="avatar-img rounded-circle"
                                                src="{{ URL::to('/assets/upload/' . $roomEdit->fileupload) }}"
                                                alt="{{ $roomEdit->fileupload }}">
                                        </a>
