                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="custom-file">
                                        <input type="file" class="custom-file-input @error('fileupload') is-invalid @enderror"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-check">
                                        <input type="checkbox" class="form-check-input" id="has_projector"
                                            name="has_projector" value="1" {{ $roomEdit->has_projector ? 'checked' : '' }}>
                                    ...
                                    <div class="form-check">
                                        <input type="checkbox" class="form-check-input" id="has_sound_system"
                                            name="has_sound_system" value="1" {{ $roomEdit->has_sound_system ? 'checked' : '' }}>
                                        <label class="form-check-label" for="has_sound_system">Sound System</label>
                                    </div>
                                    <div class="form-check">
                                        <input type="checkbox" class="form-check-input" id="has_tv"
                                            name="has_tv" value="1" {{ $roomEdit->has_tv ? 'checked' : '' }}>
