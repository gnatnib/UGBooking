                        ...
                        <div class="row formtype">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <div class="input-group-append">
                                            <button type="button" class="btn btn-primary" onclick="openAddRoomTypeModal()">Add New Type</button>
                                            <button type="button" class="btn btn-danger" onclick="openDeleteRoomTypeModal()">Delete Type</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control @error('capacity') is-invalid @enderror" id="capacity" name="capacity" min="1" max="50">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="alert alert-warning">Warning: Deleting a room type cannot be undone!</div>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
...
$(document).ready(function() {
    $('#room_images').on('change', function() {
        ...
        $(this).siblings('.custom-file-label').text(files.length > 1 ? `${files.length} files selected` : files[0].name);
    });
    ...
    $('#saveRoomType').click(function() {
        ...
        $.ajax({
            ...
            type: "POST",
            data: { new_room_type: newRoomType },
